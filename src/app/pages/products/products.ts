import { Component, computed, input, signal, EventEmitter} from '@angular/core';
...
@Component({
  ...
  imports: [ProductCard, MatSidenavModule, MatSidenavContainer, MatSidenavContent, MatSidenav, MatNavList, RouterLink, TitleCasePipe, MatListModule ],
